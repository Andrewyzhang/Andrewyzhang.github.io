...
var work_scroll = document.getElementsByClassName("work_selector");
for (var i = 0; i < work_scroll.length; i++) {
  work_scroll[i].addEventListener("click", function () {
    smoothScroll("#work", 700);
  });
}
